...
\@x{}\moduleLeftDash\@xx{ {\MODULE} euclidsAlgorithm}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers ,\, gcd ,\, TLC}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANTS} M ,\, N}%
\@x{ {\ASSUME} M \.{\in} Nat \.{\,\backslash\,} \{ 0 \}}%
\@x{ {\ASSUME} N\@s{1.53} \.{\in} Nat \.{\,\backslash\,} \{ 0 \}}%
\@pvspace{16.0pt}%
\begin{lcom}{5.0}%
...
\@x{ {\p@mmfair} {\p@algorithm} Euclid {\p@lbrace}}%
 \@x{\@s{16.4} {\p@variables} x \.{\in} 1 \.{\dotdot} N ,\, y \.{\in} 1
 \.{\dotdot} N ,\, x0 \.{=} x ,\, y0 \.{=} y {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{32.8} {\p@lbrace}}%
\@x{\@s{53.3} {\p@while} {\p@lparen} x \.{\neq} y {\p@rparen} {\p@lbrace}}%
\@x{\@s{69.7} {\p@if} {\p@lparen} x\@s{3.24} \.{<} y {\p@rparen} {\p@lbrace}}%
\@x{\@s{88.54} y \.{:=} y \.{-} x}%
\@x{\@s{69.7} {\p@rbrace} {\p@else} {\p@lbrace}}%
\@x{\@s{91.31} x \.{:=} x \.{-} y}%
\@x{\@s{69.7} {\p@rbrace}}%
\@x{\@s{53.3} {\p@rbrace} {\p@semicolon}}%
 \@x{\@s{36.89} {\p@assert} ( x \.{=} y ) \.{\land} ( x \.{=} GCD ( x0 ,\, y0
 ) )}%
\@pvspace{8.0pt}%
\@x{\@s{32.8} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
...
\@x{\@s{37.72} \.{\land} pc\@s{1.07} \.{=}\@w{Lbl\_1}}%
\@pvspace{32.0pt}%
\@x{ Lbl\_1 \.{\defeq} \.{\land} pc \.{=}\@w{Lbl\_1}}%
\@x{\@s{42.84} \.{\land} {\IF} x \.{\neq} y}%
\@x{\@s{66.11} \.{\THEN} \.{\land} {\IF} x \.{<} y}%
\@x{\@s{120.69} \.{\THEN} \.{\land} y \.{'}\@s{0.10} \.{=} y \.{-} x}%
\@x{\@s{152.00} \.{\land} x \.{'} \.{=} x}%
\@x{\@s{120.69} \.{\ELSE} \.{\land} x \.{'} \.{=} x \.{-} y}%
\@x{\@s{152.00} \.{\land} y \.{'}\@s{0.10} \.{=} y}%
\@x{\@s{97.42} \.{\land} pc \.{'} \.{=}\@w{Lbl\_1}}%
 \@x{\@s{66.11} \.{\ELSE} \.{\land} Assert ( ( x \.{=} y ) \.{\land} ( x \.{=}
 GCD ( x0 ,\, y0 ) ) ,\,}%
\@x{\@s{141.12}\@w{Failure\ of\ assertion\ at\ line\ 21,\ column\ 24.} )}%
\@x{\@s{97.42} \.{\land} pc \.{'} \.{=}\@w{Done}}%
\@x{\@s{97.42} \.{\land} {\UNCHANGED} {\langle} x ,\, y {\rangle}}%
\@x{\@s{42.84} \.{\land} {\UNCHANGED} {\langle} x0 ,\, y0 {\rangle}}%
\@pvspace{16.0pt}%
\@x{ Next \.{\defeq} Lbl\_1}%
\@x{\@s{52.13} \.{\lor}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ PartialCorrectness \.{\defeq} ( pc \.{=}\@w{Done} ) \.{\implies} ( x
 \.{=} y ) \.{\land} ( x \.{=} GCD ( x0 ,\, y0 ) )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
...
\begin{cpar}{1}{F}{F}{0}{0}{}%
 These two definitions of \ensuremath{Lbl\_1} are isomorphic to the
 auto-generated pluscal definition
 (at least as far as \ensuremath{TLC} is concerned), and I find them much
 easier to read.
 The mixed use of \mbox{'}if then else\mbox{'} control flow and
 conjunction/disjunction is
 mad uncomfortable.
\end{cpar}%
...
\vshade{5.0}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
\ensuremath{IfThenElse \.{\defeq} \.{\lor} \.{\land}} (\ensuremath{x \.{<} y})
\end{cpar}%
\begin{cpar}{0}{T}{F}{42.5}{0}{}%
\ensuremath{\.{\land}} (\ensuremath{y\.{'} \.{=} y \.{-} x})
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land}} (\ensuremath{x\.{'} \.{=} x})
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land}} (\ensuremath{pc\.{'} \.{=} \@w{Lbl\_1}})
\end{cpar}%
\begin{cpar}{1}{T}{F}{35.0}{0}{}%
\ensuremath{\.{\lor} \.{\land}} (\ensuremath{y \.{<} x})
\end{cpar}%
\begin{cpar}{0}{T}{F}{7.5}{0}{}%
\ensuremath{\.{\land}} (\ensuremath{x\.{'} \.{=} x \.{-} y})
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land}} (\ensuremath{y\.{'} \.{=} y})
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land}} (\ensuremath{pc\.{'} \.{=} \@w{Lbl\_1}})
\end{cpar}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
\ensuremath{\.{\lor} \.{\land}} (\ensuremath{x \.{=} y})
\end{cpar}%
\begin{cpar}{0}{T}{F}{7.5}{0}{}%
\ensuremath{\.{\land}} (\ensuremath{pc\.{'} \.{=} \@w{Done}})
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} {\UNCHANGED} {\langle} x,\, y {\rangle}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\land} Assert ((x \.{=} y) \.{\land} (x \.{=} GCD(x0,\,
 y0)),\, \@w{Failure of assertion at line 21, column 24.})
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{2}{F}{F}{0}{0}{}%
\ensuremath{Lbl\_1 \.{\defeq} \.{\land} pc \.{=} \@w{Lbl\_1}
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{22.5}{0}{}%
\ensuremath{\.{\land} IfThenElse
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} {\UNCHANGED} {\langle} x0,\, y0 {\rangle}
}%
\end{cpar}%
\vshade{15.0}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
 \ensuremath{IfThenElse\_impl \.{\defeq} \.{\land}} (\ensuremath{x \.{<} y})
 \ensuremath{\.{\implies} \.{\land} y\.{'} \.{=} y \.{-} x
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{82.5}{0}{}%
\ensuremath{\.{\land} x\.{'} \.{=} x
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} pc\.{'} \.{=} \@w{Lbl\_1}
}%
\end{cpar}%
\begin{cpar}{1}{T}{F}{47.5}{0}{}%
 \ensuremath{\.{\land}} (\ensuremath{x \.{>} y}) \ensuremath{\.{\implies}
 \.{\land} x\.{'} \.{=} x \.{-} y
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{35.0}{0}{}%
\ensuremath{\.{\land} y\.{'} \.{=} y
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{T}{F}{22.5}{0}{}%
\ensuremath{\.{\land} IfThenElse\_impl
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} {\UNCHANGED} {\langle} x0,\, y0 {\rangle}
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Nov} 11
 12:30:58 \ensuremath{CST} 2018 by \ensuremath{pnkm
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Nov} 11 12:16:43
 \ensuremath{CST} 2018 by \ensuremath{pnkm
}%
\end{cpar}%
\end{lcom}%
\end{document}
